...
(function() {
    ...
    e.prototype = {
        ...
        getAttribute: Ext.isIE ? function(l, n) {
            var o = this.dom,
                m = typeof o[n + ":" + l];
            if (["undefined", "unknown"].indexOf(m) == -1) {
                return o[n + ":" + l]
            }
            return o[l]
        } : function(l, m) {
            var n = this.dom;
            return n.getAttributeNS(m, l) || n.getAttribute(m + ":" + l) || n.getAttribute(l) || n[l]
        },
        update: function(l) {
            if (this.dom) {
