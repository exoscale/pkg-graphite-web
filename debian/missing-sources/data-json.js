...
Ext.extend(Ext.data.JsonReader, Ext.data.DataReader, {
    ...
    readResponse: function(e, b) {
        var f = (b.responseText !== undefined) ? Ext.decode(b.responseText) : b;
        if (!f) {
        ...
        var c = new Ext.data.Response({
            action: e,
            success: this.getSuccess(f),
            data: (a) ? this.extractData(a, false) : [],
            message: this.getMessage(f),
            raw: f
        });
    ...
    buildExtractors: function() {
        ...
        this.getRoot = l.root ? this.createAccessor(l.root) : function(f) {
            return f
        };
