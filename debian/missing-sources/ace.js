(function() {
    ...
    var c = function(a, b) {
        if (Object.prototype.toString.call(a) === "[object Array]") {
            ...
            if (typeof a == "string") {
                var i = d(a);
                return !i && c.original ? c.original.apply(window, arguments) : (b && b(), i)
            }
            if (c.original) return c.original.apply(window, arguments)
        }
    };
    c.packaged = !0, a.require && (c.original = a.require), a.require = c;
    var d = function(a) {
    ...
    var e = a("pilot/dom"),
        f = a("pilot/event"),
        g = a("ace/editor").Editor,
        h = a("ace/edit_session").EditSession,
        i = a("ace/undomanager").UndoManager,
        j = a("ace/virtual_renderer").VirtualRenderer;
    b.edit = function(b) {
    ...
    a("pilot/fixoldbrowsers"), b.startup = function(b, c) {
        a("pilot/types/basic").startup(b, c), a("pilot/types/command").startup(b, c), a("pilot/types/settings").startup(b, c), a("pilot/commands/settings").startup(b, c), a("pilot/commands/basic").startup(b, c), a("pilot/settings/canon").startup(b, c), a("pilot/canon").startup(b, c)
    ...
    i.stringify = function(a) {
        ...
        return isNaN(b.value) && (b.status = g.INVALID, b.message = "Can't convert \"" + a + '" to a number.'), b
    ...
    b.startup = function() {
        if (n) return;
        n = !0, d.registerType(h), d.registerType(i), d.registerType(k), d.registerType(j), d.registerType(l), d.registerType(m)
    }, b.shutdown = function() {
    ...
    function h(a, b) {
        ...
        var d = g[a];
        return typeof d == "function" && (d = new d(b)), d
    }
    var d = {
        VALID: {
            toString: function() {
    ...
    b.Status = d, b.Conversion = e, f.prototype = {
        stringify: function(a) {
    ...
    function x(a, b, c, d) {
        ...
        for (var f = 0; f < e.length; f++)
            if (e[f].sender(a, b, c, d)) return e[f].command;
        var g = r[b];
        return g && g[c] && g[c][d]
    }
    ...
    function C(a) {
        ...
        for (var d in c)
            for (var e in c[d])
                for (var f in c[d][e]) c[d][e][f] == a && delete c[d][e][f];
        var g = s;
        for (var d in g)
            for (var e in g[d]) g[d][e].forEach(function(b, c) {
    ...
    function G(a, b, c, e, f) {
        ...
        if (g.getStatus() == l.INVALID) return d.error("Canon.exec: Invalid parameter(s) passed to " + a.name), !1;
    ...
    f.implement(J.prototype, i), J.prototype.getParamStatus = function(a) {
        ...
        for (var c = 0; c < b.length; c++)
            if (b[c].name == a) return this.getParamStatus(b[c]);
        ...
        return this._begunOutput || this._beginOutput(), typeof a != "string" && !(a instanceof Node) && (a = a.toString()), this.outputs.push(a), this.isDone = !0, this._dispatchEvent("output", {}), this
    ...
    var d = a("pilot/useragent"),
        ...
        h = {
            ...
            opera: function(a) {
                ...
                return b.splice(f, b.length - f), b
            },
            other: function(a) {
                var b = "{anonymous}",
                    c = /function\s*([\w\-$]+)?\s*\(/i,
    ...
    b.startup = function(a, b) {
        ...
        set: function(a) {
            ...
            this.value = a, this._settings.persister && this._settings.persister.persistValue(this._settings, this.name, a), this._dispatchEvent("change", {
                setting: this,
                value: a
            })
        },
    ...
    }, e.implement(j.prototype, g), k.prototype = {
        ...
        _list: function() {
            var a = [];
            return this.getSettingNames().forEach(function(b) {
                a.push({
                    key: b,
    ...
    var d = {
        ...
        e = {
            ...
            exec: function(a, b, c) {
                ...
                if (!d) {
                    c.doneWithError("No setting with the name <strong>" + b.setting + "</strong>.");
                    return
                }
                d.reset(), c.done("Reset " + d.name + " to default: " + a.settings.get(b.setting))
            }
        },
        f = a("pilot/canon");
    b.startup = function(a, b) {
    ...
    b.REASONS = {
        ...
        install: function(b, c) {
            var e = new d;
            return this.status > this.NEW ? (e.resolve(this), e) : (a([this.name], function(a) {
                a.install && a.install(b, c), this.status = this.INSTALLED, e.resolve(this)
            }.bind(this)), e)
        },
        register: function(b, c) {
            var e = new d;
            return this.status != this.INSTALLED ? (e.resolve(this), e) : (a([this.name], function(a) {
        ...
        startup: function(c, e) {
            ...
            var f = new d;
            return this.status != this.REGISTERED ? (f.resolve(this), f) : (a([this.name], function(a) {
                a.startup && a.startup(c, e), this.status = this.STARTED, f.resolve(this)
            }.bind(this)), f)
        },
        shutdown: function(b, c) {
            if (this.status != this.STARTED) return;
            pluginModule = a(this.name), pluginModule.shutdown && pluginModule.shutdown(b, c)
        }
    ...
    Promise = function() {
        ...
        return typeof a == "function" && (this._status === h ? a.call(null, this._value) : this._status === g && this._onSuccessHandlers.push(a)), typeof b == "function" && (this._status === f ? b.call(null, this._value) : this._status === g && this._onErrorHandlers.push(b)), this
    }, Promise.prototype.chainPromise = function(a) {
        var b = new Promise;
        return b._chainedFrom = this, this.then(function(c) {
            try {
                b.resolve(a(c))
            } catch (d) {
                b.reject(d)
        ...
        if (this._status != g) return d.group("Promise already closed"), d.error("Attempted " + f + "() with ", c), d.error("Previous status = ", this._status, ", previous value = ", this._value), d.trace(), this._completeTrace && (d.error("Trace of previous completion:"), this._completeTrace.log(5)), d.groupEnd(), this;
    ...
    b.createElement = function(a, b) {
        ...
        d.overflow = "scroll";
        var g = a.offsetWidth;
        return f == g && (g = c.clientWidth), e.removeChild(c), f - g
    ...
    function g(a, b, c) {
        ...
        return f & 8 && (c == 91 || c == 93) && (c = 0), f != 0 || c in d.FUNCTION_KEYS ? a(b, f, c) : !1
    }
    var d = a("pilot/keys"),
        e = a("pilot/useragent"),
        f = a("pilot/dom");
    b.addListener = function(a, b, c) {
        ...
        function g(e) {
            c(e), f || (f = !0, d()), b.removeListener(a, "mousemove", c), b.removeListener(a, "mouseup", g), b.removeListener(a, "losecapture", g), a.releaseCapture()
        }
        var f = !1;
        ...
        var d = 0,
            e = function(a) {
                a.wheelDelta !== undefined ? (Math.abs(a.wheelDeltaY) > d && (d = Math.abs(a.wheelDeltaY)), d > 5e3 ? factor = 400 : factor = 8, a.wheelDeltaX !== undefined ? (a.wheelX = -a.wheelDeltaX / factor, a.wheelY = -a.wheelDeltaY / factor) : (a.wheelX = 0, a.wheelY = -a.wheelDelta / factor)) : a.axis && a.axis == a.HORIZONTAL_AXIS ? (a.wheelX = (a.detail || 0) * 5, a.wheelY = 0) : (a.wheelX = 0, a.wheelY = (a.detail || 0) * 5), c(a)
            };
...
}), define("ace/editor", ["require", "exports", "module", "pilot/fixoldbrowsers", "pilot/oop", "pilot/event", "pilot/lang", "pilot/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "pilot/event_emitter"], function(a, b, c) {
    ...
    var d = a("pilot/oop"),
        ...
        i = a("ace/mouse/mouse_handler").MouseHandler,
        ...
        o = function(a, b) {
            ...
            this.container = c, this.renderer = a, this.textInput = new h(a.getTextAreaContainer(), this), this.keyBinding = new j(this), g.isIPad || (this.$mouseHandler = new i(this)), this.$blockScrolling = 0, this.$search = (new l).set({
                wrap: !0
            }), this.setSession(b || new k(""))
        };
    (function() {
        d.implement(this, n), this.$forwardEvents = {
            gutterclick: 1,
            gutterdblclick: 1
            ...
            this.renderer.updateLines(c.start.row, d), this._dispatchEvent("change", a), this.renderer.updateCursor()
            ...
            var a = this.$getSelectedRows(),
                b;
            a.last == 0 || a.last + 1 < this.session.getLength() ? b = new m(a.first, 0, a.last + 1, 0) : b = new m(a.first - 1, this.session.getLine(a.first - 1).length, a.last, this.session.getLine(a.last).length), this.session.remove(b), this.clearSelection()
    ...
    b.TextInput = g
}), define("ace/mouse/mouse_handler", ["require", "exports", "module", "pilot/event", "ace/mouse/default_handlers", "ace/mouse/mouse_event"], function(a, b, c) {
    var d = a("pilot/event"),
        e = a("ace/mouse/default_handlers").DefaultHandlers,
        f = a("ace/mouse/mouse_event").MouseEvent,
        g = function(a) {
...
}), define("ace/mouse/default_handlers", ["require", "exports", "module", "pilot/event", "pilot/dom", "pilot/event_emitter", "pilot/browser_focus"], function(a, b, c) {
    function m(a) {
    ...
    var d = a("pilot/event"),
        ...
        g = a("pilot/browser_focus").BrowserFocus,
        h = 0,
        i = 1,
        j = 2,
        k = 250,
    ...
    (function() {
        this.onMouseDown = function(a) {
            ...
            var b = a.inSelection(),
                c = a.pageX,
                f = a.pageY,
                g = a.getDocumentPosition(),
                m = this.editor,
                o = this,
                p = m.getSelectionRange(),
                q = p.isEmpty(),
                r = h;
            ...
            var u = c,
                ...
                B = function() {
                    clearInterval(H), r == h ? E(g) : r == j && C(), o.$clickSelection = null, r = h
                },
                C = function() {
                    ...
                    m.clearSelection();
                    var a = m.moveText(z, y);
                    if (!a) {
                        y = null;
                        return
                    }
                    m.selection.setSelectionRange(a)
                },
                D = function() {
                    if (r == h) {
                        var a = n(c, f, u, v),
            ...
            var b = a.getDocumentPosition(),
                c = this.editor,
                d = c.session.getFoldAt(b.row, b.column, 1);
            d ? c.session.expandFold(d) : (c.moveCursorToPosition(b), c.selection.selectWord(), this.$clickSelection = c.getSelectionRange())
...
}), define("ace/mouse/mouse_event", ["require", "exports", "module", "pilot/event", "pilot/dom"], function(a, b, c) {
    var d = a("pilot/event"),
        e = a("pilot/dom"),
        f = b.MouseEvent = function(a, b) {
            this.domEvent = a, this.editor = b, this.pageX = d.getDocumentX(a), this.pageY = d.getDocumentY(a), this.$pos = null, this.$inSelection = null, this.propagationStopped = !1, this.defaultPrevented = !1
        };
    (function() {
    ...
    (function() {
        this.setKeyboardHandler = function(a) {
            ...
            var i = !1;
            return g && (i = h.exec(g.command, e, "editor", g.args), i && f.stopEvent(a)), i
        }, this.onCommandKey = function(a, b, c, d) {
            return d || (d = e.keyCodeToString(c)), this.$callKeyboardHandler(a, b, d, c)
    ...
    e.addCommand({
        ...
        exec: function(a, b, c) {
            var d = prompt("Find:", a.editor.getCopyText());
            a.editor.find(d)
        }
    }), e.addCommand({
        name: "replace",
        ...
        name: "selecttostart",
        bindKey: f("Ctrl-Shift-Home|Alt-Shift-Up", "Command-Shift-Up"),
        exec: function(a, b, c) {
        ...
        name: "selecttoend",
        bindKey: f("Ctrl-Shift-End|Alt-Shift-Down", "Command-Shift-Down"),
        exec: function(a, b, c) {
        ...
        exec: function(a, b, c) {
            a.editor.remove("left")
        }
    }), e.addCommand({
        name: "removetolinestart",
        bindKey: f("Alt-Backspace", "Option-Backspace"),
        exec: function(a, b, c) {
            a.editor.removeToLineStart()
        }
    }), e.addCommand({
        name: "removetolineend",
        bindKey: f("Alt-Delete", "Ctrl-K"),
        exec: function(a, b, c) {
            a.editor.removeToLineEnd()
        }
    }), e.addCommand({
        name: "removewordleft",
        bindKey: f("Ctrl-Backspace", "Alt-Backspace|Ctrl-Alt-Backspace"),
        exec: function(a, b, c) {
            a.editor.removeWordLeft()
        }
    }), e.addCommand({
        name: "removewordright",
        bindKey: f("Ctrl-Delete", "Alt-Delete"),
        exec: function(a, b, c) {
    ...
    var d = a("pilot/oop"),
        ...
        l = a("ace/background_tokenizer").BackgroundTokenizer,
        m = function(a, b) {
    ...
    (function() {
        ...
        d.implement(this, f), this.setDocument = function(a) {
            ...
            while (m <= b) {
                ...
                if (!l) j = this.$getDisplayTokens(e.stringTrimRight(c[m]));
                else {
        ...
        this.$computeWrapSplits = function(a, b, c) {
            ...
            for (var k = 0; k < j.length; k++)
                if (j[k].screenRow < a) h = j[k].screenRow, d = j[k].docRow;
                else break;
            var l = !j.length || k == j.length,
                m = this.getLength() - 1,
                n = this.getNextFold(d),
                o = n ? n.start.row : Infinity;
            while (h <= a) {
                i = this.getRowLength(d);
                if (h + i - 1 >= a || d >= m) break;
                h += i, d++, d > o && (d = n.end.row + 1, n = this.getNextFold(d), o = n ? n.start.row : Infinity), l && j.push({
                    docRow: d,
                    screenRow: h
                })
            }
            ...
            var p = [];
            return this.$useWrapMode && (p = this.$wrapData[d], p && (f = p[a - h], a > h && p.length && (e = p[a - h - 1] || p[p.length - 1], c = c.substring(e)))), e += this.$getStringScreenWidth(c, b)[1], h + p.length < a && (e = Number.MAX_VALUE), this.$useWrapMode ? e >= f && (e = f - 1) : e = Math.min(e, c.length), n ? n.idxToPosition(e) : {
                row: d,
                column: e
            }
            ...
            a = c.row, b = c.column;
            var d = this.$rowCache.length,
                e;
            if (this.$useWrapMode) {
                e = this.$wrapData;
                if (a > e.length - 1) return {
                    row: this.getScreenLength(),
                    column: e.length == 0 ? 0 : e[e.length - 1].length - 1
                }
            }
            var f = 0,
                g = 0,
            ...
            for (var m = 0; m < l.length; m++)
                if (l[m].docRow < a) f = l[m].screenRow, k = l[m].docRow;
                else break;
            var n = !l.length || m == l.length,
                o = this.getNextFold(k),
            ...
            while (k < a) {
                ...
                f += this.getRowLength(k), k = j, n && l.push({
                    docRow: k,
                    screenRow: f
                })
            }
            ...
            return {
                row: f,
                column: this.$getStringScreenWidth(q)[0]
            }
            ...
            if (!this.$useWrapMode) {
                ...
                for (var f = 0; f < this.$wrapData.length; f++)(c = this.getFoldLine(f, b)) ? (f = c.end.row, a += 1) : a += this.$wrapData[f].length + 1;
            return a
        }
    ...
    var d = a("ace/tokenizer").Tokenizer,
        ...
        f = a("ace/mode/behaviour").Behaviour,
        g = a("ace/unicode"),
        h = function() {
    ...
    var d = function(a) {
        ...
        for (var b in this.rules) {
            var c = this.rules[b],
                ...
                e = [],
                f = 0,
                g = this.matchMappings[b] = {};
            for (var h = 0; h < d.length; h++) {
                var i = (new RegExp("(?:(" + d[h].regex + ")|(.))")).exec("a").length - 2,
                    j = d[h].regex.replace(/\\([0-9]+)/g, function(a, b) {
    ...
    (function() {
        this.addRules = function(a, b) {
            ...
            if (e)
                for (var g = 0; g < e.length; g++) e[g] = b + e[g];
            else {
                e = [];
    ...
    function g() {
        this.getFoldAt = function(a, b, c) {
            ...
            return i || (i = this.getLine(g.start.row).substring(e.end.column)), c == -1 ? i.substring(0, b - e.end.column) : c == 1 ? i.substring(b - e.end.column) : i
            ...
            return d || (o = this.$addFoldLine(new e(this.$foldData, g))), this.$useWrapMode && this.$updateWrapData(o.start.row, o.start.row), this.$modified = !0, this._dispatchEvent("changeFold", {
                data: g
            }), g
            ...
            var f = "",
                g = this.doc,
                h = "";
            return a.walk(function(a, b, c, f, i) {
                if (b < d) return;
                if (b == d) {
                    if (c < e) return;
                    f = Math.max(e, f)
            ...
            var a = this.$foldData,
                b = [];
            return b = this.$foldData.map(function(a) {
    ...
    var d = a("ace/range").Range,
        e = a("ace/edit_session/fold_line").FoldLine,
        f = a("ace/edit_session/fold").Fold;
    b.Folding = g
    ...
    var p = function(a, b) {
        ...
        this.$textLayer.addEventListener("changeCharaterSize", function() {
            ...
            offset: 0,
            height: 1
        }, this.$loop = new m(this.$renderChanges.bind(this)), this.$loop.schedule(this.CHANGE_FULL), this.setPadding(4), this.$updatePrintMargin()
    };
    (function() {
        this.showGutter = !0, this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, d.implement(this, n), this.setSession = function(a) {
            ...
            var a = this.$size.scrollerWidth - this.$padding * 2,
                b = Math.floor(a / this.characterWidth) - 1;
            ...
            var i = Math.ceil(c / this.lineHeight) - 1,
                j = Math.max(0, Math.round((this.scrollTop - b) / this.lineHeight)),
                k = j + i,
                l, m, n = {
    ...
    (function() {
        this.setSession = function(a) {
            ...
            for (;;) {
                ...
                while (j--) c.push("</div><div class='ace_gutter-cell' style='height:", a.lineHeight, "px'>¦");
                c.push("</div>"), e++
            }
    ...
    (function() {
        this.$padding = 0, this.setPadding = function(a) {
            ...
            var f = e === "background" ? 0 : this.$padding,
                g = d.lineHeight,
                h = Math.round(d.width - b.start.column * d.characterWidth),
                i = this.$getTop(b.start.row, d),
                j = Math.round(f + b.start.column * d.characterWidth);
    ...
    var d = a("pilot/oop"),
        ...
        f = a("pilot/lang"),
        g = a("pilot/useragent"),
        h = a("pilot/event_emitter").EventEmitter,
        i = function(a) {
            this.element = e.createElement("div"), this.element.className = "ace_layer ace_text-layer", this.element.style.width = "auto", a.appendChild(this.element), this.$characterSize = this.$measureSizes() || {
                width: 0,
                height: 0
    ...
    (function() {
        d.implement(this, h), this.EOF_CHAR = "¶", this.EOL_CHAR = "¬", this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.setPadding = function(a) {
            ...
            var f = 0,
                g = 0,
                h, i = this.config.characterWidth,
                j = 0,
                k = this;
    ...
    var d = a("pilot/oop"),
        ...
        g = a("pilot/event_emitter").EventEmitter,
        h = function(a) {
            this.element = e.createElement("div"), this.element.className = "ace_sb", this.inner = e.createElement("div"), this.element.appendChild(this.inner), a.appendChild(this.element), this.width = e.scrollbarWidth(), this.element.style.width = (this.width || 15) + 5 + "px", f.addListener(this.element, "scroll", this.onScroll.bind(this))
        };
    (function() {
